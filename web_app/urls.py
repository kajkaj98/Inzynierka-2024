...
urlpatterns = [
    ...
    path('impressionism', views.style_various, {'style_type': 'Impresjonizm'}, name='impressionism'),
    path('post_impressionism', views.style_various, {'style_type': 'Postimpresjonizm'}, name='post_impressionism'),
    path('expressionism', views.style_various, {'style_type': 'Ekspresjonizm'}, name='expressionism'),
